...
kotlin {
    ...
    val xcf = XCFramework("AndroidSystemProperties")

    macosArm64 {
        binaries.framework { baseName = "AndroidSystemProperties"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "AndroidSystemProperties"; xcf.add(this) }
    }
    iosSimulatorArm64 {
        binaries.framework {
            baseName = "AndroidSystemProperties"
            isStatic = true
            xcf.add(this)
        }
    }
    ...
    swiftExport {
        moduleName = "AndroidSystemProperties"
        flattenPackage = "io.github.kotlinmania.androidsystemproperties"
    }

    android {
        namespace = "io.github.kotlinmania.androidsystemproperties"
        compileSdk = 34
        minSdk = 24
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/androidsystemproperties/CodeqlEmptySentinel.kt")
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleAndroidSystemPropertiesXCFramework",
    "assembleAndroidSystemPropertiesDebugXCFramework",
    "assembleAndroidSystemPropertiesReleaseXCFramework",
    "assembleDebugIosFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleReleaseIosFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleDebugMacosFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleReleaseMacosFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleDebugTvosFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleReleaseTvosFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleDebugWatchosFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleReleaseWatchosFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAndroidSystemPropertiesXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAndroidSystemPropertiesXCFramework",
